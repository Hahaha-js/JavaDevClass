...
public class ArrayListTest {
	public static void main(String[] args) {
		...
		System.out.println("intArr - 0 : " + intArr[0]); // 같은 값이 나온다
		System.out.println("al - 1 : " + al.get(1));
		System.out.println("intArr - 1 : " + intArr[1]); // 같은 값이 나온다
		System.out.println("al - 2 : " + al.get(2));
		System.out.println("intArr - 2 : " + intArr[2]); // 같은 값이 나온다
